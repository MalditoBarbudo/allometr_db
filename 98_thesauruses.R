...
temp_allometries_creaf %>% gather('variable', 'var_id', contains('_var')) %>%
  ...
  mutate(
    ...
    translation_eng = case_when(
      var_id == 'BRH' ~ glue::glue('Branches and leaves Biomass ({var_id} [{var_units}])'),
      var_id == 'BH' ~ glue::glue('Leaves Biomass ({var_id} [{var_units}])'),
      var_id == 'Ht' ~ glue::glue('Total Height ({var_id} [{var_units}])'),
      var_id == 'DC' ~ glue::glue('Crown Diameter ({var_id} [{var_units}])'),
      var_id == 'GC' ~ glue::glue('Bark Thickness ({var_id} [{var_units}])'),
      var_id == 'VOB' ~ glue::glue('Over Bark Volume ({var_id} [{var_units}])'),
      var_id == 'IAVC' ~ glue::glue('Annual Increment of Over Bark Volume ({var_id} [{var_units}])'),
      var_id == 'VLE' ~ glue::glue('Fuel Wood Volume ({var_id} [{var_units}])'),
      var_id == 'VUB' ~ glue::glue('Under Bark Volume ({var_id} [{var_units}])'),
      var_id == 'BR' ~ glue::glue('Branches Biomass ({var_id} [{var_units}])'),
      var_id == 'BC' ~ glue::glue('Bark Biomass ({var_id} [{var_units}])'),
      var_id == 'VC' ~ glue::glue('Bark Volume ({var_id} [{var_units}])'),
      var_id == 'BAT' ~ glue::glue('Total Aerial Biomass ({var_id} [{var_units}])'),
      var_id == 'BM' ~ glue::glue('Wood Biomass ({var_id} [{var_units}])'),
      var_id == 'VM' ~ glue::glue('Wood Volume ({var_id} [{var_units}])'),
      var_id == 'DR' ~ glue::glue('Branch Diameter ({var_id} [{var_units}])'),
      var_id == 'DBH' ~ glue::glue('Diameter at Breast Height ({var_id} [{var_units}])'),
      var_id == 'DBH_SC' ~ glue::glue('Diameter Inside Bark ({var_id} [{var_units}])'),
      var_id == 'P_BST' ~ glue::glue("Total Subterranean Biomass percentage ({var_id} [{var_units}])"),
      var_id == 'BST' ~ glue::glue("Total Subterranean Biomass ({var_id} [{var_units}])"),
      var_id == 'BAL' ~ glue::glue("Basal Area of Larger Trees ({var_id} [{var_units}])"),
      var_id == 'PHV' ~ glue::glue("Phytovolume ({var_id} [{var_units}])"),
      var_id == 'BFAT' ~ glue::glue("Total Fine Aerial Biomass ({var_id} [{var_units}])"),
      var_id == 'Area' ~ glue::glue("Area ({var_id} [{var_units}])")
    ),
...
tibble::tribble(
  ...
  'independent_var_1_units', "Unitats de la variable dependent 1", "Independent variable 1 units", "Unidades de la variable independiente 1",
  ...
  'independent_var_2_units', "Unitats de la variable dependent 2", "Independent variable 2 units", "Unidades de la variable independiente 2",
  ...
  'independent_var_3_units', "Unitats de la variable dependent 3", "Independent variable 3 units", "Unidades de la variable independiente 3",
